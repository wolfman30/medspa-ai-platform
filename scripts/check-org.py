#!/usr/bin/env python3
"""Check org ID for brandi.forever22@gmail.com"""
...
print("\n2. Looking up org by email (brandi.forever22@gmail.com):")
org_lookup = api_get(f"{API_URL}/api/client/org?email=brandi.forever22@gmail.com", token)
