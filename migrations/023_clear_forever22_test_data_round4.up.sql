...
WHERE conversation_id IN (
  ...
  WHERE org_id = 'd0f9d4b4-05d2-40b3-ad4b-ae9a3b5c8599'
    AND (phone LIKE '%3303339270%' OR phone LIKE '%3308059026%' OR phone LIKE '%3303332654%' OR phone LIKE '%5005550001%')
);
