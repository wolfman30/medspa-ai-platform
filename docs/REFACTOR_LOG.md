...
| 2026-03-15 | #104 | Remove 2,231 lines of dead code: unwired `internal/support/` (1,294 lines) and `internal/rebooking/` (933 lines) packages + commented-out voice callback in telnyx_webhooks.go | `internal/support/*`, `internal/rebooking/*`, `internal/http/handlers/telnyx_webhooks.go` |
| 2026-03-15 | #105 | Split `bootstrap_helpers.go` (548→4 files: helpers 43L, messaging 96L, payments 163L, voice 324L) + extracted helpers (Boulevard prefetch, transcript callback, clinic name, biz hours filter) | `internal/bootstrap/bootstrap_{helpers,messaging,payments,voice}.go` |
