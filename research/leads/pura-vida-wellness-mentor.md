# Pura Vida Wellness — Mentor, OH

## Overview
- **Type**: Medical spa / wellness clinic
- **Location**: 9179 Mentor Ave, Unit K, Mentor, OH 44060
- **Phone**: (440) 290-0755
- **Website**: https://www.puravidawellnessmentor.com/
- **Facebook**: https://www.facebook.com/p/Pura-Vida-Wellness-61551438407240/
- **Owner/Key Staff**: Ashley (injector mentioned in reviews); Adrienne Rose (photographer/staff)
- **EMR**: Unknown — uses Wix-based website, no visible booking platform
- **Founded**: Listed on Mentor Chamber; appears relatively new

## Services
- Medical weight loss (GLP-1, Semaglutide, Tirzepatide)
- Injectables: Botox, Dysport, dermal filler, Sculptra, Kybella, PRP
- Skin treatments: CO2 hybrid laser, SkinPen microneedling, chemical peels, dermaplaning, laser hair removal
- IV vitamin drips, NAD+, peptides, bioidentical hormone therapy
- TED hair restoration, Glo2Facial

## Fit Assessment
- **Priority**: HIGH
- **Phone prominent**: Yes — (440) 290-0755 on Facebook, Yelp, Chamber listing
- **Independent**: Yes — single location, not a chain
- **Injectable-heavy**: Yes — Botox, Dysport, filler, Sculptra, Kybella, PRP
- **Market**: Lake County / Mentor — no current prospects in this area
- **Booking**: No clear online booking system visible — likely phone/text-heavy
- **Reviews**: Very positive on Yelp (weight loss success stories, happy injectable clients)
