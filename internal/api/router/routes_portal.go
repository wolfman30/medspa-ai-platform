...
// registerPortalRoutes mounts customer portal routes. These are read-only
// endpoints scoped to the org owner, used by clinic operators to view their
// own dashboards, conversations, deposits, and knowledge base.
